...
def q04():
    numero = (input('Digite qualquer numero:'))

    print (numero)

def q05():
    numero1 = float(input('digite qualquer numero:'))
...
def q06():
    ...
    print (f'O antecessor é: {sucessor}')
    print (f'O sucessor é: {antecessor}')
...
def q08():
    ...
    print (f'o resultando da subtração é: {result}')

def q09():
    numero = float(input('digite qualquer numero:'))
    
    result = numero/4
    print (f'O 1/4 desse numero é: {result}')
...
def q16(): 
    ...
    reajus_salario = float(input('Valor do reajuste: R$'))

    valor_final = salario_atual*reajus_salario/100

    print (f'Seu salario agora é: R${valor_final}')


def q17(): 
    graus_centígrados = float(input('Celsius: Cº'))
    Fahrenheit = float(input('fahrenheit: Fº'))

    Fahre = (9 x Celsius + 160) / 5

    print (f'a temperatura da conversão é: {fahre}')

def q18():
    tempo_viagem = float(input('tempo decorrido na viagem:'))
    velocidade_média = float(input('velocidade média:'))
...
def q01L2():
    ...
    if result > 10: 
        print (f"{result} o número é maior que 10: ")
...
def q17(): 
    ...
    print (f'a temperatura da conversão é: {Fahrenheit}')
